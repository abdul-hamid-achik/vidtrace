...
`vidtrace` turns bug screen recordings into evidence bundles for humans and coding agents.
...
- [CLI Contract](cli-contract.md): command surface, flags, exit codes, and JSON output.
- [Artifact Schema](artifact-schema.md): generated bundle layout and JSON schemas.
